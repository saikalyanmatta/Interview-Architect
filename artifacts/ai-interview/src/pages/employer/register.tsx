    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-muted-foreground">InterviewAI — Employer Portal</p>
        </div>

        <div className="border border-border rounded-xl p-6 bg-card">
          <h2 className="text-sm font-semibold text-foreground mb-5">Your details</h2>
        ...
        <p className="text-xs text-muted-foreground mt-4 text-center">
          ...
          <button onClick={() => setLocation("/employer/login")} className="text-primary hover:underline">
            Sign in
          </button>
        </p>
